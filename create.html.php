      ...
      <table class="table table-form">
        <tbody>
          <tr>
            ...
            <td>
              ...
              <span class="input-group-addon"><?php echo $lang->bug->module?></span>
                ...
                ?>
              <span class='input-group-addon fix-border'><?php echo $lang->bug->attribute?></span>
              <?php echo html::select('attribute', $lang->bug->attributeList, $attribute, "class='form-control chosen'");?>
              <span class='input-group-addon fix-border'><?php echo $lang->bug->source?></span>
              <?php echo html::select('source', $lang->bug->sourceList, $source, "class='form-control chosen' ");?>
              </div>
            </td>
          </tr>
          ...
          <tr>
            ...
            <td>
              <div class='input-group'>
              <span class='input-group-addon fix-border'><?php echo $lang->bug->difficulty;?></span>
              <?php echo html::select('difficulty', $lang->bug->difficultyList, $difficulty, "class='form-control chosen' ");?>
              <span class='input-group-addon fix-border'><?php echo $lang->bug->workload;?></span>
              <?php echo html::select('workload', $lang->bug->workloadList, $workload, "class='form-control chosen' ");?>
              <span class='input-group-addon fix-border'><?php echo $lang->bug->schedule;?></span>
              <?php echo html::select('schedule', $lang->bug->scheduleList, $schedule, "class='form-control chosen' ");?>
              </div>
            </td>
          </tr>
          <?php endif;?>
          <tr>
            ...
            <td colspan='2'>
              <div class="input-group title-group">
                ...
                <div class='input-group'>
                <span class='input-group-addon fix-border'><?php echo $lang->bug->taskpackage;?></span>
                <?php echo html::input('taskpackage', '0',"class='form-control' autocomplete='off'");?>
                </div>
              </div>
            </td>
          </tr>
